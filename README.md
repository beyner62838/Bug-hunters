...
Adicionalmente, la plataforma incorpora un módulo de inclusión productiva mediante rutas de formación básica y conexión con empresas aliadas, con el fin de ofrecer oportunidades de aprendizaje y empleabilidad a mediano y largo plazo.
...
Se desperdician alimentos en buen estado en comercios.
Comunidades vulnerables no tienen acceso suficiente a alimentos.
Además, hay falta de oportunidades de formación y empleo.
...
🍽️ Módulo 1: Rescate y distribución de alimentos
Registro de alimentos disponibles por comercios
Visualización de ofertas por organizaciones
...
Postulación a oportunidades laborales
👥 Actores del sistema
🏪 Donantes: supermercados, panaderías, restaurantes, tiendas
🏘️ Receptores: fundaciones, comedores comunitarios, líderes barriales
🧑‍💼 Administrador: coordina, valida y organiza la distribución
👨‍🎓 Beneficiarios: personas en situación vulnerable
🏢 Empresas aliadas: ofrecen empleo, cursos y prácticas
⚙️ MVP (Producto mínimo viable)
Registro de donantes
Publicación de alimentos disponibles
